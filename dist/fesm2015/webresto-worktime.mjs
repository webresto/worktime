...
class WorkTimeValidator {
    ...
    static getPossibleSelfServiceOrderDateTime(restriction, currentdate) {
         ...
         * */
        const newRestriction = Object.assign(Object.assign({}, restriction), { worktime: restriction.worktime.map((worktime) => worktime) });
...
export { ScheduleGenerator, ScheduleValidator, TimeZoneIdentifier, WorkTimeValidator, formatDate, isDate };
